        ...
        <Col>
          ...
          <Row>
            <Col>
              ...
              <Button className="btn-nav w-75 mt-3" onClick={editProfile}>
                Edit Profile
              </Button>
            </Col>
            <Col>
              <div className="mb-5">
                <p>FullName</p>
                <p className="profile-text">{isLogin.name}</p>
              </div>
              <div className="mb-5">
                <p>Email</p>
                <p className="profile-text">{isLogin.email}</p>
              </div>
              <div>
                <p>Phone</p>
                <p className="profile-text">{isLogin.phone}</p>
              </div>
            </Col>
          </Row>
        </Col>
